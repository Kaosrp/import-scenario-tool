...
if module_selected == "Gerenciamento":
    ...
    with management_tabs[3]:
        ...
        # ============================
        # Adiciona um ancoradouro para o formulário
        st.markdown('<div id="product_form"></div>', unsafe_allow_html=True)
        
        # Se estiver no modo de edição, exibe um cabeçalho indicando o NCM a ser editado
        ...
        # Se estiver no modo de edição, insere um script que faz scroll suave para o formulário
